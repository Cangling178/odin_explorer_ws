...
| --- | --- | --- |
| RGB camera | Device-calibrated FishPoly geometry, 1600x1296 at 10 Hz; custom fishpoly CameraInfo; about 128.85/103.30-degree horizontal/vertical FOV | Finite cubemap/resampling precision; no exposure response, motion blur or image noise; pinhole consumers require adaptation |
...
[calib_device.yaml](../hardware/mechanical/odin1/calib_device.yaml) now drives FishPoly
image projection and CameraInfo, with the existing converted relative extrinsics.
See [FishPoly implementation and validation](FISHPOLY_CAMERA.md). Cloud `resolution_m: 0.001`
