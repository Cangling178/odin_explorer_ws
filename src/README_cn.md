...
| 包 | 职责 | 状态 |
| --- | --- | --- |
| [racer_description](odin_racer/racer_description/README_cn.md) | 机器人几何与坐标系定义 | 资源预览 |
...
| [racer_control](odin_racer/racer_control/README_cn.md) | 路径跟踪、运行状态与指令控制 | 规划中的子系统 |
| [racer_navigation](odin_racer/racer_navigation/README_cn.md) | 可选 Nav2 集成 | 规划中的子系统 |
| [racer_bringup](odin_racer/racer_bringup/README_cn.md) | 启动组合与机器人运行配置 | 资源预览 |
